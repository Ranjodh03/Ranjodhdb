...
if(isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $tour_id = $connection->real_escape_string($_GET['id']);

    // Query to retrieve tour details
    $sql = "SELECT * FROM tour WHERE id = $tour_id";
...
<head>
    ...
    <style>
        body {
            background-image: url('/ibighit/bts_read.jpeg'); /* Specify the path to your image */
...
<body>
    ...
    <div class="row">
      ...
      <!-- Highlighted text -->
    <h2 class="text-center mb-4 highlight-text">tour Details</h2>
    <form method="post">
    <table class="table">
        <tbody>
            <tr>
            ...
            <div class="row">
                        <div class="col-md-6">
                <td>Image</td>
                <td><img src="<?php echo $tour['image']; ?>" alt="tour image"></td>
</div>
</div>
            </tr>
        </tbody>
