...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["confirm_delete"])) {
    ...
    $stmt = $connection->prepare("DELETE FROM tour WHERE id = ?");
...
<meta charset="UTF-8">
    ...
    <style>
       .btn-custom-red {
        ...
        body {
            background-image: url('/ibighit/bts_delete.jpeg'); /* Specify the path to your image */
...
<body>
    ...
    <h2 class="text-center mb-4">Are you sure you want to delete this tour?</h2>
    <form method="post">
    ...
    <input type="submit" name="confirm_delete" class="btn btn-custom-red btn-sm w-100" value="Yes, delete it!">
                            ...
                            <div class="col-md-6">
    <a class="btn btn-custom-blue btn-sm w-100" href="/ibighit/index.php">No, take me back</a>
    </div>
    </div>
</form>
    </div>
